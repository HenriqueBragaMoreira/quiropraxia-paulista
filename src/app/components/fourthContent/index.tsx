...
export function FourthContent() {
  return (
    <div
      id="fifth-content"
      className="3xl:h-screen [@media(min-height:935px)]:h-screen flex flex-col gap-4 bg-[#154359] pt-20 md:pt-[88px]"
    >
      <h2 className="text-3xl md:text-5xl font-bold text-center">Contato</h2>
      <div className="flex items-center justify-around">
        <div className="flex flex-col gap-6 bg-white py-6 px-20 rounded-lg">
